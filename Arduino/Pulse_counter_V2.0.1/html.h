...
String htmlRelay(String relayStatus, String deviceName){
...
ptr +="<title>RELAY > AIME - Smart Home</title>\n";
ptr +="<style>\n";
...
ptr +="<div class=\"form-container\">\n";
        ptr +="<form action=\"/\" method=\"POST\">\n";
          ...
          if(relayStatus == "0")
          {
            ...
            ptr +="<br>\n";
            ptr +="<div>\n";
              ptr +="<button class=\"button buttonRelay\" name=\"relay\" value=\"Close\" type=\"Submit\">PRESS</button>\n";
            ptr +="</div>\n";
            }
          else
          {
            ...
            ptr +="<br>\n";
            ptr +="<div>\n";
              ptr +="<button class=\"button buttonRelay\" name=\"relay\" value=\"Open\" type=\"Submit\">PRESS</button>\n";
            ptr +="</div>\n";
            } 
          ptr +="<br>\n";
        ptr +="</form>\n";
