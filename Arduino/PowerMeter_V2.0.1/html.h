...
String htmlTH(float pzem_voltage, float pzem_current, float pzem_power, float pzem_energy, float pzem_frequency, float pzem_pf, String deviceName){
...
ptr +="<title>Power Meter > AIME - Smart Home</title>\n";
ptr +="<style>\n";
...
ptr +="<div class=\"form-container\">\n";
        ptr +="<form action=\"/\" method=\"POST\">\n";
          ...
          ptr +="<br>\n";
            ...
            ptr +="<h3>VOLTAGE: \n";
            //ptr +="<h3 class=\"pzem_voltage\">\n";
            ptr +=(float)pzem_voltage; 
            ptr +=" V</h3>\n";
            ptr +="<br>\n";
            
            ptr +="<h3>CURRENT: \n";
            //ptr +="<h3 class=\"pzem_current\">\n";
            ptr +=(float)pzem_current;
            ptr +=" A</h3>\n";
            ptr +="<br>\n";
            
            ptr +="<h3>POWER: \n";
            //ptr +="<h3 class=\"pzem_power\">\n";
            ptr +=(float)pzem_power;
            ptr +=" W</h3>\n";
            ptr +="<br>\n";
            
            ptr +="<h3>ENERGY: \n";
            //ptr +="<h3 class=\"pzem_energy\">\n";
            ptr +=(float)pzem_energy;
            ptr +=" kWh</h3>\n";
            ptr +="<br>\n";
            
            ptr +="<h3>FREQUENCY: \n";
            //ptr +="<h3 class=\"pzem_frequency\">\n";
            ptr +=(float)pzem_frequency;
            ptr +=" Hz</h3>\n";
            ptr +="<br>\n";
            
            ptr +="<h3>PF: \n";
            //ptr +="<h3 class=\"pzem_pf\">\n";
            ptr +=(float)pzem_pf;
            ptr +=" pf</h3>\n";
